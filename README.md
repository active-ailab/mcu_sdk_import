...
2. 下载原厂SDK，解压好文件如`E:\Apollo330B\AmbiqSuiteC_5.2.0\`（注意些目录结构要和platform/mcu/<mcu_name>/sdk相同）
...
新SDK：E:\Apollo330B\AmbiqSuiteC_5.2.0
...
导入完成后，会在`platform/mcu/mcu_sdk_import/out`生成`更新说明+测试用例报告excel表格`。
